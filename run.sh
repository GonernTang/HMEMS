...
# Config 1: 
CONFIGS["config1"]="--technique_type vecmem \
    --min_aug_count 4 \
...
# Config 2:
CONFIGS["config2"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.7 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
# Config 3: 
CONFIGS["config3"]="--technique_type vecmem \
    --min_aug_count 3 \
...
# Config 4:
CONFIGS["config4"]="--technique_type vecmem \
    --min_aug_count 4 \
    --min_relevant_score 0.7 \
    --retrieve_raw_topk 3 \
    --retrieve_aug_topk 5 \
    --enable_iter_anwser True \
    --output_file \${LOCOMO_RES_PATH}/vecmem_c4v3a5t7_iter_partial.json"

# Config 5 (Pure Rag):
CONFIGS["config_rag"]="--technique_type vecmem \
    --min_aug_count 4 \
...
CONFIGS["config6"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.75 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config7"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.7 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
### 4.1 mini versions
CONFIGS["config1_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 4 \
    --min_relevant_score 0.7 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
# Config 2:
CONFIGS["config2_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.7 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \ 
...
# Config 3: 
CONFIGS["config3_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.75 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
# Config 4:
CONFIGS["config4_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 4 \
    --min_relevant_score 0.7 \
    --retrieve_raw_topk 3 \
    --retrieve_aug_topk 5 \ 
...
# Config 5 (Pure Rag):
CONFIGS["config_rag_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 4 \
    --min_relevant_score 0.99 \
    --retrieve_raw_topk 10 \
    --retrieve_aug_topk 0 \
...
# Config 6 (Iterative Config 3)
CONFIGS["config6_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.75 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
# Config 7 (Iterative Config 2):
CONFIGS["config7_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.7 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t75_iter_partial_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.75 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t8_iter_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
...
CONFIGS["config_c3v5a5t8m1_iter_partial_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.8 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t8m75_iter_partial_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.8 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v6a4t8m8_iter_partial_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.8 \
    --retrieve_raw_topk 6 \
    --retrieve_aug_topk 4 \
...
CONFIGS["config_c3v5a5t7m75_iter_partial_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.7 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t8m75_iter_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.7 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c4v5a5t65m75_partial_iter_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 4 \
...
CONFIGS["config_c3v5a5t75m75_partial_semantic_s10t05_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.75 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t75m75_semantic_s10t05_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.75 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t75m75_semantic_s10t0_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.75 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t75m75_partial_semantic_s10t0_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.75 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
# t75m75 iter s10 t05
CONFIGS["config_c3v5a5t75m75_partial_iter_semantic_s10t05_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.75 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t8m75_partial_semantic_s10t05_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.8 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t8m8_partial_semantic_s10t0_4.1_mini_no_filter"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.8 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
# t8m75 iter s10 t05
CONFIGS["config_c3v5a5t8m75_partial_iter_semantic_s10t05_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.8 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
...
CONFIGS["config_c3v5a5t78m78_semantic_s10t0_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
...
CONFIGS["config_c3v5a5t78m78_semantic_s10t05_4.1_mini"]="--technique_type vecmem \
    --min_aug_count 3 \
    --min_relevant_score 0.78 \
    --retrieve_raw_topk 5 \
    --retrieve_aug_topk 5 \
